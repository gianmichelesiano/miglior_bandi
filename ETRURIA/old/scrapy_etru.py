...
while flag:  
    ...
    if responce_json[0]['gare'] == None:
        ...
        for gara in gare:
            if 1:
                cig =""
                if gara.has_key('identificativo'):
                ...
                procedura =""
                if gara.has_key('tipogara'):
                   procedura = gara['tipogara'].upper()



                ente =""
                if gara.has_key('ente'):
                ...
                citta =""
                if gara.has_key('provincia'):
                   citta = gara['provincia'].upper()

                   
                provincia =""
                if gara.has_key('siglaprov'):
                   provincia = gara['siglaprov'].upper()


                regione =""
                if gara.has_key('regione'):
                   regione = gara['regione'].upper()

                
                importo =""
                if gara.has_key('importo'):
                ...
                data_pubblicazione =""
                if gara.has_key('riferimento'):
                   data_pubblicazione =  data_per_db(gara['riferimento'])

                data_scadenza =""
                if gara.has_key('scadenza'):
